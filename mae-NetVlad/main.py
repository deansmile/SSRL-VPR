...
parser.add_argument('--dataPath', type=str, default='/scratch/ds5725/ssl_vpr/mae-NetVlad/data', help='Path for centroid data.')
parser.add_argument('--runsPath', type=str, default='/scratch/ds5725/ssl_vpr/mae-NetVlad/runs', help='Path to save runs to.')
parser.add_argument('--savePath', type=str, default='/scratch/ds5725/ssl_vpr/mae-NetVlad/checkpoints', 
...
parser.add_argument('--arch', type=str, default='mae', 
        help='basenetwork to use', choices=['vgg16', 'alexnet','mae'])
        ...
        with h5py.File(train_set.cache, mode='w') as h5: 
            ...
            with torch.no_grad():
                for iteration, (input, indices) in enumerate(whole_training_data_loader, 1):
                    input = F.interpolate(input,(224,224))
