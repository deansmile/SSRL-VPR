...
parser.add_argument('--dataPath', type=str, default='/scratch/bh2470/ssl_vpr/pytorch-NetVlad/data', help='Path for centroid data.')
parser.add_argument('--runsPath', type=str, default='/scratch/bh2470/ssl_vpr/pytorch-NetVlad/runs', help='Path to save runs to.')
parser.add_argument('--savePath', type=str, default='/scratch/bh2470/ssl_vpr/pytorch-NetVlad/checkpoints', 
